...
export default function StatementsView({ transactions, accounts, selectedAccountId, onSelectAccount }: StatementsViewProps) {
          ...
          {visible.map(tx => {
            ...
            return (
              <div key={tx.id} className="grid grid-cols-[1fr_auto_auto_auto] gap-3 px-4 py-2.5 border-b border-white/[0.03] last:border-0 hover:bg-white/[0.02] transition-colors">
                ...
                <span
                  className="self-center px-2 py-0.5 rounded-full text-[10px] font-medium whitespace-nowrap"
